---
title: AlphaVantage GraphQL Schema
description: The full schema for refrence
---

# AlphaVantage GraphQL Schema

We have provided the full schema definition for reference:
