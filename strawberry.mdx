...
<center>
	<img
		src="https://i.imgur.com/TEN5GLj.png"
		alt="Strawberry"
		width="100"
	/>
</center>
...
@strawberry.type
class Query:
	@strawberry.field(permission_classes=[PermissionClass])
	def test(self):
		...
```

### Accessing User Information [¶](https://strawberry.rocks/docs/guides/permissions#accessing-user-information)
